...
# Bugs fixed there: backwards hints, string-vs-int comparison, score rewarding wrong guesses.
...
if submit:
    ...
    if not ok:
        ...
        # alphabetical comparison instead of numeric. Removed that branch entirely.
        # FIX: always pass the integer secret to check_guess.
